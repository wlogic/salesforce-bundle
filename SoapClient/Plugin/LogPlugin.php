<?php
namespace Phpforce\SalesforceBundle\Plugin;

use Phpforce\SalesforceBundle\Event\RequestEvent;
use Phpforce\SalesforceBundle\Event\ResponseEvent;
use Phpforce\SalesforceBundle\Event\FaultEvent;
